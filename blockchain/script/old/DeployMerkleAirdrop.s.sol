...
contract DeployMerkleAirdrop is Script {
    ...
    function deployMerkleAirdrop() public returns (MerkleAirdrop, DurianDurianToken) {
        vm.startBroadcast();
        ...
        token.mint(token.owner(), AMOUNT_TO_TRANSFER); // amount for four claimers / transfer from adress 0 to YOU
    ...
    function run() external returns (MerkleAirdrop, DurianDurianToken) {
